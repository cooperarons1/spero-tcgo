...
const HERO_POWER_PNGS: Partial<Record<HeroClass, string>> = {
  JIMMY:  '/hero-powers/JIMMY.webp',
  IZZY:   '/hero-powers/IZZY.webp',
  ASTRID: '/hero-powers/ASTRID.webp',
  TALA:   '/hero-powers/TALA.webp',
  ANDERS: '/hero-powers/ANDERS.webp',
  AVA:    '/hero-powers/AVA.webp',
  LUCAS:  '/hero-powers/LUCAS.webp',
  DES:    '/hero-powers/DES.webp',
  DEREK:  '/hero-powers/DEREK.webp',
};
...
export default function GameBoard({
  ...
  return (
    ...
    >
      ...
      {/* Action toast removed — too intrusive. The opponent-card-showcase
          (center-screen card spotlight) covers card plays; the history
          sidebar on the left shows every action as a log entry. The
          former red/green pill added visual noise without new info. */}
